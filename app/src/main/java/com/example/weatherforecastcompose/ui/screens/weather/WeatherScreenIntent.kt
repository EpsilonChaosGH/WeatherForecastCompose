...
sealed interface WeatherScreenIntent {
    ...
    data class AddToFavorites(val value: FavoriteCoordinates) : WeatherScreenIntent

    data class RemoveFromFavorites(val value: FavoriteCoordinates) : WeatherScreenIntent
